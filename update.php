...
<br>
<tr class="table table-dark"><th><input type="submit"  class="btn btn-info"><button class="btn btn-secondary"><a href="https://localhost/abd/index.php">Powrót</a></button></th></tr>
<tr>
</thead>
